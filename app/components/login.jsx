              ...
              <div className="row">
                      ...
                      <div className="well">
                          <form id="loginForm" method="POST" action="/login/">
                              <div className="form-group">
                                  ...
                                  <input type="text" className="form-control" id="username" name="username" title="Please enter you username" placeholder="example@gmail.com">
                                  </input>
                                  <span className="help-block"></span>
                              </div>
                              <div className="form-group">
                                  <label for="password" className="control-label">Password</label>
                                  <input type="password" className="form-control" id="password" name="password" title="Please enter your password">
                                  </input>
                                  <span className="help-block"></span>
                              </div>
                  ...
                  <div className="col-xs-6">
                      ...
                      <ul className="list-unstyled" >
                          <li><span className="fa fa-check text-success"></span> See interesting recipes </li>
                          <li><span classNameName="fa fa-check text-success"></span>Save your favorite recipes</li>
                          <li><span className="fa fa-check text-success"></span>Submit Recipes</li>
                          <li><span className="fa fa-check text-success"></span> Fast checkout</li>
                          <li><span className="fa fa-check text-success"></span> Search/Find Recipes</li>
